<?php  
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $r = mysqli_query($con, "SELECT konser.harga, konser.nama as nama1, konser.foto, konser.deskripsi, konser.waktu, konser.lokasi, tiket.nama as nama2, tiket.id_tiket, tiket.email FROM konser, tiket WHERE id_tiket ='$id' and tiket.id_konser = konser.id_konser");
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($err != true) {
            $result = mysqli_query($con, "UPDATE tiket SET nama='$nama', email='$email' WHERE id_tiket='$id'");
            $berhasil = "Anda Berhasil Mengedit Tiket Ini";
        } 
      }
?>
			...
			<form action="" method="post">
                <div class="main-user-info">
				  ...
				  <label for="">Nama Konser</label>
           		   		<input type="text" name="nama1"  placeholder="Nama Konser" readonly value="<?php echo $nama1; ?>">
           		   </div>
           		</div>
                <div class="main-user-info">
                  <div class="user-input-box">
				...
				<div class="main-user-info">
				  ...
				  <label for="">Nama Pembeli</label>
           		   		<input type="text" name="nama2"  placeholder="Nama Pembeli" value="<?php echo $nama2; ?>">
				...
				<div class="main-user-info">
                  <div class="user-input-box">
            		...
            		<input type="submit" class="btn" name="submit" value="EDIT" placeholder="EDIT">
					</div>
            	</div>
            </form>
            </div>
