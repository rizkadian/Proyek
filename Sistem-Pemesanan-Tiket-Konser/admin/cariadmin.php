    ...
    if (isset($_POST['tambah'])) {
      ...
      if ($err != true) {
        $berhasil = "Data Berhasil Ditambahkan";
          $result = mysqli_query($con, "INSERT INTO admin SET id_admin='', nama='$nama', email='$email', username='$username', password='$password'");
        } 
    }
?>
      ...
      <main>
        <section class="abuabu" id="pricelist">
         <br>
                ...
                <div class='card'>
                <a class="up" href= "cetakadmin.php">Cetak Data Admin</a>    
                <form id="searchthis" action="cariadmin.php" style="display:inline;" method="GET">
                    ...
                    <table class="table1" cellpadding="10" cellspacing="0">
                        ...
                        <?php if (isset($_GET['cari'])) : ?>
                            <?php
                                ...
                                $result = mysqli_query($con, "SELECT * FROM admin WHERE nama like '%$carinama%'");
                            ?>
                        ...
                        <div class='flex-box'>
                            <?php if (mysqli_num_rows($result) > 0) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row1["password"];?></td>
                                    <td>
                                        <a class="up" href= "editadmin.php?id=<?= $row1["id_admin"];?>">Edit</a> | 
                                        <a class="del" href= "deleteadmin.php?id=<?=$row1["id_admin"];?>" onclick="return confirm('Yakin data akan dihapus?');">Hapus</a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
