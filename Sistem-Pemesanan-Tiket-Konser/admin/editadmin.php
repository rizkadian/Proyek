<?php   
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $r = mysqli_query($con, "SELECT * FROM admin WHERE id_admin ='$id'");
    ...
    if (isset($_POST['tambah'])) {
      ...
      if ($err != true) {
          $result = mysqli_query($con, "UPDATE admin SET nama='$nama', email='$email', username='$username', password='$password' WHERE id_admin='$id'");
